...
LAZY MODE enabled for optimal performance.

Lazy Mode: Operations are accumulated and executed as graphs
...
# =============================================================
# 1. Environment Setup for Gaudi Lazy Mode
# =============================================================
import os

# CRITICAL: Enable Lazy Mode BEFORE importing PyTorch
...
print(f"{'='*60}")
print(f"BERT SST-2 Benchmark - Intel Gaudi HPU (LAZY MODE)")
print(f"{'='*60}")
print(f"Using device: {device}")
print(f"Lazy Mode: ENABLED (PT_HPU_LAZY_MODE=1)")
print(f"{'='*60}\n")
...
# Create DataLoaders
# Note: pin_memory is not used for HPU
...
# =============================================================
# 10. Training Loop with Benchmarking (Lazy Mode)
# =============================================================
print("\n" + "="*60)
print("Starting Training (LAZY MODE)...")
print("="*60 + "\n")
...
for epoch in range(CONFIG["num_epochs"]):
    ...
    for batch in pbar:
        ...
        # CRITICAL: mark_step() in lazy mode to trigger graph execution
        htcore.mark_step()
    ...
    with torch.no_grad():
        for batch in tqdm(val_loader, desc="Validating"):
            ...
            # mark_step for inference in lazy mode
            htcore.mark_step()
...
# =============================================================
print("="*60)
print("Measuring Inference Latency (LAZY MODE)...")
print("="*60)
...
# =============================================================
print("\n" + "="*60)
print("BENCHMARK RESULTS - Intel Gaudi HPU (LAZY MODE)")
print("="*60)
...
# =============================================================
results_file = "benchmark_results_gaudi_lazy.json"
with open(results_file, "w") as f:
    json.dump(benchmark_results, f, indent=2)
print(f"\nResults saved to {results_file}")

# Save model
model.save_pretrained("bert_sst2_gaudi_lazy_model")
tokenizer.save_pretrained("bert_sst2_gaudi_lazy_model")
print("Model saved to bert_sst2_gaudi_lazy_model/")
print("\nBenchmark Complete!")
